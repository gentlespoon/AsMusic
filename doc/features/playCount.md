...
**Out of scope:** Last.fm-style mid-track thresholds, `scrobble(submission=false)` now-playing, `setRating`, album/artist derived-index rollups of playCount, list-row play-count badges. Most-played / recently-played **browse** lives on the Recommendations hub — see [`recommendations.md`](./recommendations.md).
...
| Recently-played Recommendations section | Done — ranks by cached `played` ([`recommendations.md`](./recommendations.md)) |
